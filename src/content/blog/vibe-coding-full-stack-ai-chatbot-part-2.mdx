...
The other thing I love about Biome is how **blazing fast** it is. It's written in Rust, and you can feel the difference immediately. Formatting an entire monorepo happens in milliseconds, not seconds. When you're iterating quickly, withs lots of code being generated by AI, that speed compounds.
