...
Up until now, I've been breaking down each feature into multiple smaller prompts and steps. This approach worked well for demonstrating the thought process and making it easier to follow along.

However, I've noticed that **GPT 5.2 with extra high reasoning** has become remarkably precise, even when given large context windows and complex multi-part instructions. The model handles comprehensive prompts exceptionally well, maintaining coherence across all requirements without losing track of details.

**From this part onwards, I'll be using single, detailed prompts** that describe the entire feature we want to build. This approach:
- Better reflects how I actually work with these models now
- Reduces back-and-forth iterations
- Lets the AI see the full picture and make better architectural decisions
- Takes advantage of the model's high reasoning capabilities
