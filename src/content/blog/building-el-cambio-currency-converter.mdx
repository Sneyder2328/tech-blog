...
description: "How I built El Cambio, a fast PWA for Venezuela’s official BCV exchange rates—React, NestJS, tRPC, Prisma, and an offline-first UX."
pubDate: 2026-01-12
tags: ["react", "nestjs", "pwa", "typescript", "venezuela", "currency", "ai-coding", "fullstack"]
---

Here's the story of why and how I built my latest project, **El Cambio**, in just a few hours using modern web technologies and AI coding tools. It's open source and available on GitHub at: <a href="https://github.com/Sneyder2328/bcv-rates" target="_blank" rel="noopener noreferrer">https://github.com/Sneyder2328/bcv-rates</a>
...
For the server, I chose NestJS with tRPC, Prisma ORM, and PostgreSQL as the database. These decisions were mostly based on the modern, type-safe tech stack I now use for most of my projects, which I described in greater detail in <a href="https://blog.sneyderangulo.com/blog/vibe-coding-full-stack-ai-chatbot-part-2" target="_blank" rel="noopener noreferrer">this tutorial post series</a>.

Following the approach described in <a href="https://blog.sneyderangulo.com/blog/vibe-coding-full-stack-ai-chatbot-part-3" target="_blank" rel="noopener noreferrer">this other tutorial post series</a>, I handled the scaffolding for the monorepo, the React web app, and the NestJS server manually. Then I let the AI handle the coding by providing specific details for how I wanted the app to work.
...
![El Cambio Currency Converter Screenshot](/images/building-el-cambio-currency-converter-screenshot.png)
...
If you are Venezuelan or simply curious about the project, feel free to check it out at <a href="https://cambio.sneyderangulo.com/" target="_blank" rel="noopener noreferrer">El Cambio</a> or explore the <a href="https://github.com/Sneyder2328/bcv-rates" target="_blank" rel="noopener noreferrer">source code on GitHub</a>. Contributions and feedback are always welcome. And if you run into issues, have feature ideas, or want to contribute, feel free to open an issue or a pull request. I’d love to keep improving it based on real usage.